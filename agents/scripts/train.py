...
from agents.tools.basic_env import BasicEnv
from agents.tools.pixels_env import PixelsEnv
...
def _create_environment(config):
  ...
  """
    ...
    # print(config.domain)
    env = suite.load(domain_name=config.domain, task_name=config.task)
